...
(async () => {
    try {
        ...
        console.log('Eliminando función antigua...');
        await client.query('DROP FUNCTION IF EXISTS app.sp_get_menus_usuario(integer)');
        
        console.log('Creando nueva función con columna permission_required...');
        await client.query(`
